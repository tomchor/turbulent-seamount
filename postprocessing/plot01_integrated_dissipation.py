...
seamounts.plot.scatter(ax=ax, hue="total_dissip_height", **fixed_options, norm=LogNorm(), vmin=1e3, vmax=1e6)
#---
...
binned_seamounts.total_dissip_height.plot(ax=axes[1], y="latitude_bins")
#---
